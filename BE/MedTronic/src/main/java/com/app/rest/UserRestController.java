...
public class UserRestController {
	...
	@GetMapping("/allUsers")
	public ResponseEntity<ArrayList<User>> getAllUsers()throws CustomException {
	...
	public ResponseEntity<User> validateUser(@Valid @RequestBody UserDTO userdto) throws CustomException {
		User user=this.userService.validateUser(userdto);
	...
	public ResponseEntity<User> resetPassword(@Valid @RequestBody UserDTO userdto) throws CustomException {
		User user=this.userService.resetPassword(userdto);	
		return new ResponseEntity<>(user,HttpStatus.OK);
